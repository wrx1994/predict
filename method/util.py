...
def cal_train_past(time, id, slice_1,slice_2,slice_3,slice_4,slice_5,slice_6,slice_7,slice_8,slice_9,slice_10,slice_11,slice_12):
    ...
    type_list = [int(slice_1_value[0]),int(slice_2_value[0]),int(slice_3_value[0]),int(slice_4_value[0]),int(slice_5_value[0]),
                 ...
                 int(slice_5_value[1]), int(slice_6_value[1]), int(slice_7_value[1]), int(slice_8_value[1]),
                 int(slice_9_value[1]), int(slice_10_value[1]), int(slice_11_value[1]), int(slice_12_value[1]),
                int(slice_1_value[2]), int(slice_2_value[2]), int(slice_3_value[2]), int(slice_4_value[2]),
                int(slice_5_value[2]), int(slice_6_value[2]), int(slice_7_value[2]), int(slice_8_value[2]),
                int(slice_9_value[2]), int(slice_10_value[2]), int(slice_11_value[2]), int(slice_12_value[2]),
                int(slice_1_value[3]), int(slice_2_value[3]), int(slice_3_value[3]), int(slice_4_value[3]),
                int(slice_5_value[3]), int(slice_6_value[3]), int(slice_7_value[3]), int(slice_8_value[3]),
                int(slice_9_value[3]), int(slice_10_value[3]), int(slice_11_value[3]), int(slice_12_value[3])
                ]
    return type_list

def cal_train_future(predict_6):
...
def cal_test(time, id, slice_1,slice_2,slice_3,slice_4,slice_5,slice_6,slice_7,slice_8,slice_9,slice_10,slice_11,slice_12):
    slice_1_value = slice_1.split(' ')
    slice_2_value = slice_2.split(' ')
    slice_3_value = slice_3.split(' ')
    slice_4_value = slice_4.split(' ')
